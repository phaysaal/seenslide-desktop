...
class DeduplicationEngine:
    ...
    def __init__(
        ...
        import tempfile
        self._rejected_folder = Path(tempfile.gettempdir()) / "seenslide" / "rejected" / session.session_id
    ...
    def _mark_as_duplicate(
        ...
        rejection_rate = (self._duplicate_slides / self._total_captures * 100) if self._total_captures > 0 else 0.0
        logger.info(
